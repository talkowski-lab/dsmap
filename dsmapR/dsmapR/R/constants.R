...
load.constants <- function(subset){
  # Define colors
  cnv.colors <- list("DEL.colors" = list("dark2" = "#4F1C14",
                                         "dark1" = "#9F2B1C",
                                         "main" = "#D43925",
                                         "light1" = "#DD6151",
                                         "light2" = "#E5887C"),
                     "DUP.colors" = list("dark2" = "#003F6A",
                                         "dark1" = "#1A5985",
                                         "main" = "#2376B2",
                                         "light1" = "#4F91C1",
                                         "light2" = "#7BADD1"),
                     "CNV.colors" = list("dark2" = "#3F2759",
                                         "dark1" = "#5F3B85",
                                         "main" = "#7E4EB2",
                                         "light1" = "#9B6081",
                                         "light2" = "#B488A1"))
  other.colors <- list("greens" = list("dark2" = "#0C4923",
                                       "dark1" = "#116D34",
                                       "main" = "#179145",
                                       "light1" = "#45A76A",
                                       "light2" = "#74BD8F"),
                       "oranges" = list("dark2" = "#7E3809",
                                        "dark1" = "#BD530E",
                                        "main" = "#FC6F12",
                                        "light1" = "#FD8C41",
                                        "light2" = "#FDA971"),
                       "browns" = list("dark2" = "#6A4838",
                                       "dark1" = "#9F6C54",
                                       "main" = "#D49070",
                                       "light1" = "#DDA68D",
                                       "light2" = "#E5BCA9"),
  ...
  # Define names
  dsmap.names <- list(
    "performance.metric.abbrevs" = c("accuracy" = "Acc.",
                                     "sensitivity" = "Sens.",
                                     "specificity" = "Spec.",
                                     "ppv" = "PPV",
                                     "npv" = "NPV",
