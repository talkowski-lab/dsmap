...
| [`athena/`](https://github.com/talkowski-lab/dsmap/tree/main/data/athena) | Reference files for athena commands |  
...
Note that GCP permissions will be required to access the contents of this bucket. For permissions to access this bucket, please [email Lily Wang](mailto:lily_wang@hms.harvard.edu)  
